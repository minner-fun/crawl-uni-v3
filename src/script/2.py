...
if __name__ == "__main__":
    ...
    def run():
        ...
        provider = Web3.HTTPProvider(MAINNET_RPC_URL)
        ...
        print(number)
        RCC_ADDRESS = w3.to_checksum_address("0x9b6443b0fb9c241a7fdac375595cea13e6b7807a")
        ...
        state.restore()
        # RCC_ADDRESS = w3.to_checksum_address(RCC_ADDRESS)
